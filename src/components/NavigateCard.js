...
import { selectDestination, setDestination } from "../app/slices/navigationSlice";
  ...
  return (
    <SafeAreaView style={tw`bg-white flex-1 justify-between`}>
      <View style={tw`flex-shrink`}>
        <Text style={tw`text-center pb-5 text-lg`}>
          Good morning, Friend
        </Text>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() =>  destination&&navigation.navigate("RideOptionsCard")}
        >
